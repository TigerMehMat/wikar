let Updater = require('./GlobalControllers/updater.js');

const ARK_api = require('./GlobalControllers/ARK_api.js');
const Discord = require('discord.js');

const GlobalVarsModel = new (require('../Models/GlobalVarsModel.js'));
